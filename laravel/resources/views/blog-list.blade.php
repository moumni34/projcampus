                    ...
                    <div class="blog-info clearfix">
                        <div class="post-left">
                            <ul>
                                <li>
                                    <div class="post-author">
                                        <a href="{{url('instructor-profile')}}"><img src="{{ URL::asset('/assets/img/user/user1.jpg')}}" alt="Post Author"> <span>Jenis R.</span></a>
                                    </div>
                                </li>
                                <li><img class="img-fluid" src="{{ URL::asset('/assets/img/icon/icon-22.svg')}}" alt="">May 20, 2021</li>
                    ...
                    <div class="blog-info clearfix">
                        <div class="post-left">
                            <ul>
                                <li>
                                    <div class="post-author">
                                        <a href="{{url('instructor-profile')}}"><img src="{{ URL::asset('/assets/img/user/user3.jpg')}}" alt="Post Author"> <span>Rolands R</span></a>
                                    </div>
                                </li>
