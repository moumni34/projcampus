...
@slot('li1') Student @endslot
@slot('li2') Student Profile @endslot 
@endcomponent
@component('components.pagebanner') 
    @slot('title') Gabriel Palmer @endslot  
    @slot('li1') Student @endslot
@endcomponent			
                                ...
                                <div class="course-box course-design d-flex " >
                                    <div class="product">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <h3 class="title product-content-title"><a href="{{url('course-details')}}">Information About UI/UX Design Degree</a></h3>
                                ...
                                <div class="course-box course-design d-flex " >
                                    <div class="product">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <h3 class="title product-content-title"><a href="{{url('course-details')}}">Wordpress for Beginners - Master Wordpress Quickly</a></h3>
                                            <div class="course-info d-flex align-items-center border-0 m-0">
                                                <div class="rating-img d-flex align-items-center">
                                                    <img src="{{ URL::asset('/assets/img/icon/icon-01.svg')}}" alt="">
                                                    <p>12+ Lesson</p>
