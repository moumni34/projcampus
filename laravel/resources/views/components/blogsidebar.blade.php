        ...
        <ul class="latest-posts">
            <li>
                ...
                <div class="post-info">
                    ...
                    <p><img class="img-fluid" src="{{ URL::asset('/assets/img/icon/icon-22.svg')}}" alt="">Jun 14, 2022</p>
                </div>
            </li>
            <li>
                <div class="post-thumb">
                ...
                <div class="post-info">
                    ...
                    <p><img class="img-fluid" src="{{ URL::asset('/assets/img/icon/icon-22.svg')}}" alt=""> 3 Dec 2019</p>
                </div>
            </li>
            <li>
                <div class="post-thumb">
