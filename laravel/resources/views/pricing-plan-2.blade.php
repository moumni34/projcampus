    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 text-center mx-auto">
                ...
                <div class="text-end">
                    <img src="{{ URL::asset('/assets/img/plan.png')}}" alt="icon">
                </div>
                    ...
                    <table class="table table-bordered table-price">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><img src="{{ URL::asset('/assets/img/icon/check-circle.svg')}}" alt="icon"></td>
                                <td class="text-center"><img src="{{ URL::asset('/assets/img/icon/check-circle.svg')}}" alt="icon"></td>
                                <td class="text-center"><img src="{{ URL::asset('/assets/img/icon/check-circle.svg')}}" alt="icon"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Multi-device</td>
                                <td class="text-center"><img src="{{ URL::asset('/assets/img/icon/close-circle.svg')}}" alt="icon"></td>
                                <td class="text-center"><img src="{{ URL::asset('/assets/img/icon/check-circle.svg')}}" alt="icon"></td>
                                <td class="text-center"><img src="{{ URL::asset('/assets/img/icon/check-circle.svg')}}" alt="icon"></td>
                            </tr>
                            <tr>
