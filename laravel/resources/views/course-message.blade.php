            ...
            <div class="student-widget-group">
                <div class="col-md-12">
                    <div class="add-compose">
                        <a href="javascript:;" class="btn btn-primary"><i class="feather-solid feather-plus"></i> Compose</a>
                    </div>
                </div>
                <div class="col-md-12">
                            ...
                            <div class="chat-users-list">
                                <div class="chat-scroll">
                                    <a href="javascript:void(0);" class="media d-flex">
                                        <div class="media-img-wrap flex-shrink-0">
                                            <div class="avatar avatar-away">
                                                <img src="{{ URL::asset('/assets/img/user/user1.jpg')}}" alt="User Image" class="avatar-img rounded-circle">
                                            </div>
                                        </div>
                                    ...
                                    <a href="javascript:void(0);" class="media read-chat active d-flex">
                                        <div class="media-img-wrap flex-shrink-0">
                                            <div class="avatar avatar-online">
                                                <img src="{{ URL::asset('/assets/img/user/user2.jpg')}}" alt="User Image" class="avatar-img rounded-circle">
                                            </div>
                                        </div>
                                        <div class="media-body flex-grow-1">
                                            <div>
                                    ...
                                    <a href="javascript:void(0);" class="media read-chat active d-flex">
                                        <div class="media-img-wrap flex-shrink-0">
                                            <div class="avatar avatar-online">
                                                <img src="{{ URL::asset('/assets/img/user/user3.jpg')}}" alt="User Image" class="avatar-img rounded-circle">
                                            </div>
                                        </div>
                                        <div class="media-body flex-grow-1">
                                            <div>
                                    ...
                                    <a href="javascript:void(0);" class="media read-chat active d-flex">
                                        <div class="media-img-wrap flex-shrink-0">
                                            <div class="avatar avatar-online">
                                                <img src="{{ URL::asset('/assets/img/user/user4.jpg')}}" alt="User Image" class="avatar-img rounded-circle">
                                            </div>
                                        </div>
                                        <div class="media-body flex-grow-1">
                                            <div>
                                    ...
                                    <a href="javascript:void(0);" class="media d-flex">
                                        <div class="media-img-wrap flex-shrink-0">
                                            <div class="avatar avatar-away">
                                                <img src="{{ URL::asset('/assets/img/user/user5.jpg')}}" alt="User Image" class="avatar-img rounded-circle">
                                            </div>
                                        </div>
                                        <div class="media-body flex-grow-1">
                                            <div>
                                    ...
                                    <a href="javascript:void(0);" class="media d-flex">
                                        <div class="media-img-wrap flex-shrink-0">
                                            <div class="avatar avatar-away">
                                                <img src="{{ URL::asset('/assets/img/user/user6.jpg')}}" alt="User Image" class="avatar-img rounded-circle">
                                            </div>
                                        </div>
                                        <div class="media-body flex-grow-1">
                                            <div>
                                    ...
                                    <a href="javascript:void(0);" class="media d-flex">
                                        <div class="media-img-wrap flex-shrink-0">
                                            <div class="avatar avatar-away">
                                                <img src="{{ URL::asset('/assets/img/user/user7.jpg')}}" alt="User Image" class="avatar-img rounded-circle">
                                            </div>
                                        </div>
                                        <div class="media-body flex-grow-1">
                                            <div>
                        ...
                        <div class="chat-cont-right">
                            ...
                            <div class="chat-footer">
                                <div class="input-group">
                                    ...
                                    <button type="button" class="btn btn-primary msg-send-btn rounded-pill"><img src="{{ URL::asset('/assets/img/send-icon.svg')}}" alt="" ></button>
                                </div>
                            </div>
                        </div>
                        <!-- /Chat Right -->
