<?php $page="instructor-grid-2";?>
@extends('layout.mainlayout')
@section('content')	
@component('components.breadcrumb')   
@slot('title') Home @endslot
@slot('li1') Pages @endslot
@slot('li2') Instructors Grid @endslot 
@endcomponent
<!-- Page Wrapper -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex">
                        <div class="instructor-box instruct-grid flex-fill">
                            <div class="instructor-img">
                                <a href="{{url('instructor-profile')}}">
                                    <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/user/user1.jpg')}}">
                                </a>
                                <a href="#rate" class="rating-count"><i class="fa-regular fa-heart"></i></a>
                            </div>
                            <div class="instructor-content">												
                    ...
                    <div class="col-lg-4 col-md-6 d-flex">
                        <div class="instructor-box instruct-grid flex-fill">
                            <div class="instructor-img">
                                <a href="{{url('instructor-profile')}}">
                                    <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/user/user13.jpg')}}">
                                </a>
                                <a href="#rate" class="rating-count"><i class="fa-regular fa-heart"></i></a>
                            </div>
                            <div class="instructor-content">												
                                <h5><a href="{{url('instructor-profile')}}">Monroe Parker</a></h5>
                                <h6>Instructor</h6>
                                <div class="rating-img d-flex align-items-center justify-content-center">
                                    <img src="{{ URL::asset('/assets/img/icon/icon-01.svg')}}" class="me-1" alt="">
                                    <p>12+ Lesson</p>
