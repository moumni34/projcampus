        ...
        <div class="row ">
            ...
            <div class="col-md-5 d-flex align-items-center">
                <div class="girl-slide-img aos" data-aos="fade-up">
                    <img src="{{ URL::asset('/assets/img/object.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="owl-carousel mentoring-course owl-theme aos" data-aos="fade-up">
            ...
            <div class="feature-box text-center " >
                <div class="feature-bg" >
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="{{ URL::asset('/assets/img/categories-icon-01.png')}}" alt="">
                        </div>		
                        <div class="feature-cont">	
            ...
            <div class="feature-box text-center " >		
                <div class="feature-bg" >
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="{{ URL::asset('/assets/img/categories-icon-02.png')}}" alt="">
                        </div>		
                        <div class="feature-cont">	
            ...
            <div class="feature-box text-center " >	
                <div class="feature-bg" >
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="{{ URL::asset('/assets/img/categories-icon-03.png')}}" alt="">
                        </div>		
                        <div class="feature-cont">	
            ...
            <div class="feature-box text-center " >		
                <div class="feature-bg" >
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="{{ URL::asset('/assets/img/categories-icon-04.png')}}" alt="">
                        </div>		
                        <div class="feature-cont">	
            ...
            <div class="feature-box text-center " >					
                <div class="feature-bg" >
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="{{ URL::asset('/assets/img/categories-icon-05.png')}}" alt="">
                        </div>		
                        <div class="feature-cont">	
                        ...
                        <div class="product">
                            <div class="product-img">
                                <a href="{{url('course-details')}}">
                                    <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/course/course-01.jpg')}}">
                                </a>
                                <div class="price">
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="{{url('instructor-profile')}}"><img src="{{ URL::asset('/assets/img/user/user1.jpg')}}" alt="" class="img-fluid"></a>
                                ...
                                <h3 class="title instructor-text"><a href="{{url('course-details')}}">Information About UI/UX Design Degree</a></h3>
                ...
                <div class="col-lg-4 col-md-6 d-flex">
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            <div class="product-img">
                                <a href="{{url('course-details')}}">
                                    <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/course/course-02.jpg')}}">
                                </a>
                                <div class="price">
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="{{url('instructor-profile')}}"><img src="{{ URL::asset('/assets/img/user/user2.jpg')}}" alt="" class="img-fluid"></a>
                                        <div class="course-name">
                ...
                <div class="col-lg-4 col-md-6 d-flex">
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            <div class="product-img">
                                <a href="{{url('course-details')}}">
                                    <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/course/course-03.jpg')}}">
                                </a>
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="{{url('instructor-profile')}}"><img src="{{ URL::asset('/assets/img/user/user5.jpg')}}" alt="" class="img-fluid"></a>
                                        <div class="course-name">
                ...
                <div class="col-lg-4 col-md-6 d-flex">
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            <div class="product-img">
                                <a href="{{url('course-details')}}">
                                    <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/course/course-04.jpg')}}">
                                </a>
                                <div class="price">
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="{{url('instructor-profile')}}"><img src="{{ URL::asset('/assets/img/user/user4.jpg')}}" alt="" class="img-fluid"></a>
                                        <div class="course-name">
                                            <h4><a href="{{url('instructor-profile')}}">Nicole Brown</a></h4>
                                            <p>Instructor</p>
                                        </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex">
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            <div class="product-img">
                                <a href="{{url('course-details')}}">
                                    <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/course/course-05.jpg')}}">
                                </a>
                                <div class="price">
                                    <h3>$300 <span>$99.00</span></h3>
                                </div>
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="{{url('instructor-profile')}}"><img src="{{ URL::asset('/assets/img/user/user3.jpg')}}" alt="" class="img-fluid"></a>
                                        <div class="course-name">
                                ...
                                <h3 class="title instructor-text"><a href="{{url('course-details')}}">Build Responsive Real World Websites with HTML5 and CSS3</a></h3>
                                <div class="course-info d-flex align-items-center">
                                    <div class="rating-img d-flex align-items-center">
                                        <img src="{{ URL::asset('/assets/img/icon/icon-01.svg')}}" alt="">
                                        <p>13+ Lesson</p>
                ...
                <div class="col-lg-4 col-md-6 d-flex">
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            <div class="product-img">
                                <a href="{{url('course-details')}}">
                                    <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/course/course-06.jpg')}}">
                                </a>
                                <div class="price combo">
                                    <h3>FREE</h3>
                                </div>
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="{{url('instructor-profile')}}"><img src="{{ URL::asset('/assets/img/user/user6.jpg')}}" alt="" class="img-fluid"></a>
                                        <div class="course-name">
                                ...
                                <h3 class="title instructor-text"><a href="{{url('course-details')}}">C# Developers Double Your Coding Speed with Visual Studio</a></h3>
                                <div class="course-info d-flex align-items-center">
                                    <div class="rating-img d-flex align-items-center">
                                        <img src="{{ URL::asset('/assets/img/icon/icon-01.svg')}}" alt="">
                                        <p>7+ Lesson</p>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-12 d-flex align-items-end">
                <div class="career-img aos" data-aos="fade-up">
                    <img src="{{ URL::asset('/assets/img/join.png')}}" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="owl-carousel trending-course owl-theme aos" data-aos="fade-up">
            <div class="course-box trend-box">
                <div class="product trend-product">
                    <div class="product-img">
                        <a href="{{url('course-details')}}">
                            <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/course/course-07.jpg')}}">
                        </a>
                        <div class="price">
                    ...
                    <div class="product-content">
                        <div class="course-group d-flex">
                            <div class="course-group-img d-flex">
                                <a href="{{url('instructor-profile')}}"><img src="{{ URL::asset('/assets/img/user/user.jpg')}}" alt="" class="img-fluid"></a>
                                <div class="course-name">
            ...
            <div class="course-box trend-box">
                <div class="product trend-product">
                    <div class="product-img">
                        <a href="{{url('course-details')}}">
                            <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/course/course-08.jpg')}}">
                        </a>
                        <div class="price">
                            <h3>$300 <span>$99.00</span></h3>
                        </div>
            ...
            <div class="course-box trend-box">
                <div class="product trend-product">
                    <div class="product-img">
                        <a href="{{url('course-details')}}">
                            <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/course/course-09.jpg')}}">
                        </a>
                        <div class="price">
                            <h3>$100 <span>$99.00</span></h3>
                        </div>
        ...
        <div class="feature-instructors">
            ...
            <div class="owl-carousel instructors-course owl-theme aos" data-aos="fade-up">
                <div class="instructors-widget">
                    <div class="instructors-img ">
                        <a href="{{url('instructor-list')}}">
                            <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/user/user7.jpg')}}">
                        </a>
                    </div>
                ...
                <div class="instructors-widget">
                    <div class="instructors-img">
                        <a href="{{url('instructor-list')}}">
                            <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/user/user8.jpg')}}">
                        </a>
                    </div>
                    <div class="instructors-content text-center">
                ...
                <div class="instructors-widget">
                    <div class="instructors-img">
                        <a href="{{url('instructor-list')}}">
                            <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/user/user9.jpg')}}">
                        </a>
                    </div>
                    <div class="instructors-content text-center">
                ...
                <div class="instructors-widget">
                    <div class="instructors-img">
                        <a href="{{url('instructor-list')}}">
                            <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/user/user10.jpg')}}">
                        </a>
                    </div>
                    <div class="instructors-content text-center">
    ...
    <div class="review">
        <div class="container">
            <div class="testi-quotes">
                <img src="{{ URL::asset('/assets/img/qute.png')}}" alt="" >
            </div>
                        ...
                        <div class="testimonial-two-head text-center align-items-center d-flex">
                            <div class="testimonial-four-saying ">
                                <div class="testi-right">
                                    <img src="{{ URL::asset('/assets/img/qute-01.png')}}" alt="">
                                </div>
    ...
    <div class="container">
        ...
        <div class="owl-carousel blogs-slide owl-theme aos" data-aos="fade-up">
            <div class="instructors-widget blog-widget">
                <div class="instructors-img">
                    <a href="{{url('blog-list')}}">
                        <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/blog/blog-01.jpg')}}">
                    </a>
                </div>
                <div class="instructors-content text-center">
            ...
            <div class="instructors-widget blog-widget">
                <div class="instructors-img">
                    <a href="{{url('blog-list')}}">
                        <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/blog/blog-02.jpg')}}">
                    </a>
                </div>
                <div class="instructors-content text-center">
            ...
            <div class="instructors-widget blog-widget">
                <div class="instructors-img">
                    <a href="{{url('blog-list')}}">
                        <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/blog/blog-03.jpg')}}">
                    </a>
                </div>
                <div class="instructors-content text-center">
            ...
            <div class="instructors-widget blog-widget">
                <div class="instructors-img">
                    <a href="{{url('blog-list')}}">
                        <img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/blog/blog-04.jpg')}}">
                    </a>
                </div>
                <div class="instructors-content text-center">
