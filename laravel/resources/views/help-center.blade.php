...
@slot('li2') Help Center @endslot 
@endcomponent
@component('components.pagebanner')   
@slot('title') How can we help you? @endslot
@slot('li1') Have questions? Search through our Help Center @endslot
@endcomponent
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">	
                            <div class="support-img">	
                                <img src="{{ URL::asset('/assets/img/service-01.png')}}" class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6">					
                <div class="support-card">
                    <div class="row">
                        ...
                        <div class="col-md-4">	
                            <div class="support-img">	
                                <img src="{{ URL::asset('/assets/img/service-02.png')}}" class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
                </div>
