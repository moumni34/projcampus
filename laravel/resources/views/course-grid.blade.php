                        ...
                        <div class="course-box course-design d-flex " >
                            <div class="product">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="title"><a href="{{url('course-details')}}">Learn and Understand AngularJS to become a ...</a></h3>
                                    <div class="course-info d-flex align-items-center">
                                        <div class="rating-img d-flex align-items-center">
                                            <img src="{{ URL::asset('/assets/img/icon/icon-01.svg')}}" alt="">
                                            <p>12+ Lesson</p>
                            ...
                            <ul class="latest-posts">
                                <li>
                                    <div class="post-thumb">
                                        <a href="{{url('course-details')}}">
                                            <img class="img-fluid" src="{{ URL::asset('/assets/img/blog/blog-01.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info free-color">
                                        <h4>
                                            <a href="{{url('course-details')}}">Introduction LearnPress – LMS plugin</a>
                                        </h4>
                                        <p>FREE</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="post-thumb">
                                        <a href="{{url('course-details')}}">
                                            <img class="img-fluid" src="{{ URL::asset('/assets/img/blog/blog-02.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
                                            <a href="{{url('course-details')}}">Become a PHP Master and Make Money</a>
                                        </h4>
                                        <p>$200</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="post-thumb">
                                        <a href="{{url('course-details')}}">
                                            <img class="img-fluid" src="{{ URL::asset('/assets/img/blog/blog-03.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info free-color">
                                        <h4>
                                            <a href="{{url('course-details')}}">Learning jQuery Mobile for Beginners</a>
                                        </h4>
                                        <p>FREE</p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="post-info">
                                        <h4>
                                            <a href="{{url('course-details')}}">Improve Your CSS Workflow with SASS</a>
                                        </h4>
                                        <p>$200</p>
                                    </div>
                                </li>
