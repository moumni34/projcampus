...
@component('components.pagebanner') 
    @slot('title') Jenny Wilson @endslot  
    @slot('li1') Instructor @endslot
@endcomponent		
                    ...
                    <div class="card-body">
                        ...
                        <div class="profile-overview-list">
                            <div class="list-grp-blk d-flex">
                                ...
                                <img src="{{ URL::asset('/assets/img/instructor/courses-icon.png')}}" alt="Courses" >
                                </div>
                            ...
                            <div class="list-grp-blk d-flex">
                                <div class="flex-shrink-0">
                                <img src="{{ URL::asset('/assets/img/instructor/ttl-stud-icon.png')}}" alt="Total Students" >
                                </div>
                                <div class="list-content-blk flex-grow-1 ms-3">
                                <h5>11,604</h5>
                                <p>Total Students</p>
                            ...
                            <div class="list-grp-blk d-flex">
                                <div class="flex-shrink-0">
                                <img src="{{ URL::asset('/assets/img/instructor/review-icon.png')}}" alt="Reviews" >
                                </div>
                                <div class="list-content-blk flex-grow-1 ms-3">
                                <h5>12,230</h5>
                                <p>Reviews</p>
                ...
                <div class="card overview-sec">
                    <div class="card-body">
                        ...
                        <div class="contact-info-list">
                            <div class="edu-wrap">
                                <div class="edu-name">	
                                    <span><img src="{{ URL::asset('/assets/img/instructor/email-icon.png')}}" alt="Address"></span>
                                </div>
                                <div class="edu-detail">	
                                    <h6>Email</h6>
                            ...
                            <div class="edu-wrap">
                                <div class="edu-name">	
                                    <span><img src="{{ URL::asset('/assets/img/instructor/address-icon.png')}}" alt="Address"></span>
                                </div>
                                <div class="edu-detail">	
                                    <h6>Address</h6>
                            ...
                            <div class="edu-wrap">
                                <div class="edu-name">	
                                    <span><img src="{{ URL::asset('/assets/img/instructor/phone-icon.png')}}" alt="Address"></span>
                                </div>
                                <div class="edu-detail">	
                                    <h6>Phone</h6>
