                    ...
                    <div class="col-lg-12 col-md-12 d-flex">
                        <div class="course-box course-design list-course d-flex">
                            <div class="product">
                                ...
                                <div class="product-content">
                                    <div class="head-course-title">
                                        <h3 class="title"><a href="{{url('course-details')}}">Learn and Understand AngularJS to become a professional developer</a></h3>
                                        <div class="all-btn all-category d-flex align-items-center">
                                            <a href="{{url('checkout')}}" class="btn btn-primary">BUY NOW</a>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="latest-posts">
                                ...
                                <li>
                                    ...
                                    <div class="post-info free-color">
                                        <h4>
                                            <a href="{{url('blog-details')}}">Learning jQuery Mobile for Beginners</a>
                                        </h4>
                                        <p>FREE</p>
                                    </div>
                                </li>
