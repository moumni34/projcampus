                        ...
                        <div id="collapseOne" class="card-collapse collapse" style="">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div>
                                        <img src="{{ URL::asset('/assets/img/icon/play-icon.svg')}}" alt="" >
                                    </div>
                                </li>
                                <li>
                                    <p>Course Introduction </p>
                                    <div>
                                        <img src="{{ URL::asset('/assets/img/icon/lock.svg')}}" alt="" >
                                    </div>
                                </li>
                                <li>
                                    <p>About the Exam</p>
                    ...
                    <div class="lesson-widget-group">
                        ...
                        <div class="introduct-video">
                            <a href="https://www.youtube.com/embed/1trvO6dqQUI" class="video-thumbnail" data-fancybox="">
                                ...
                                <img class="" src="{{ URL::asset('/assets/img/video-img-01.jpg')}}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
