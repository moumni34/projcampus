                    ...
                    <div className="student-box flex-fill">
                      <div className="student-box-blks">
                        ...
                        <div className="student-content pb-0">
                          <h5>
                            <Link to="/student-profile">Wade Warren</Link>
                          </h5>
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6 d-flex">
                    <div className="student-box flex-fill">
                      <div className="student-box-blks">
                        ...
                        <div className="student-content pb-0">
                          <h5>
                            <Link to="/student-profile">Dianna Smiley</Link>
                          </h5>
                          <div className="loc-blk d-flex align-items-center justify-content-center">
                            <i className="feather-map-pin me-2"></i>
                            <p>Tunisia</p>
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6 d-flex">
                    <div className="student-box flex-fill">
                      <div className="student-box-blks">
                        ...
                        <div className="student-content pb-0">
                          <h5>
                            <Link to="/student-profile">Esther Howard</Link>
                          </h5>
                          <div className="loc-blk d-flex align-items-center justify-content-center">
                            <i className="feather-map-pin me-2"></i>
                            <p>Spain</p>
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6 d-flex">
                    <div className="student-box flex-fill">
                      <div className="student-box-blks">
                        ...
                        <div className="student-content pb-0">
                          <h5>
                            <Link to="/student-profile">Guy Hawkins</Link>
                          </h5>
                          <div className="loc-blk d-flex align-items-center justify-content-center">
                            <i className="feather-map-pin me-2"></i>
                            <p>United States</p>
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6 d-flex">
                    <div className="student-box flex-fill">
                      <div className="student-box-blks">
                        ...
                        <div className="student-content pb-0">
                          <h5>
                            <Link to="/student-profile">Jacob Jones</Link>
                          </h5>
                          <div className="loc-blk d-flex align-items-center justify-content-center">
                            <i className="feather-map-pin me-2"></i>
                            <p>United Kingdom</p>
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6 d-flex">
                    <div className="student-box flex-fill">
                      <div className="student-box-blks">
                        ...
                        <div className="student-content pb-0">
                          <h5>
                            <Link to="/student-profile">Rivao Luke</Link>
                          </h5>
                          <div className="loc-blk d-flex align-items-center justify-content-center">
                            <i className="feather-map-pin me-2"></i>
                            <p>Brazil</p>
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6 d-flex">
                    <div className="student-box flex-fill">
                      <div className="student-box-blks">
                        ...
                        <div className="student-content pb-0">
                          <h5>
                            <Link to="/student-profile">Nia Sikhone</Link>
                          </h5>
                          <div className="loc-blk d-flex align-items-center justify-content-center">
                            <i className="feather-map-pin me-2"></i>
                            <p>Italy</p>
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6 d-flex">
                    <div className="student-box flex-fill">
                      <div className="student-box-blks">
                        ...
                        <div className="student-content pb-0">
                          <h5>
                            <Link to="/student-profile">Xiaon Merry</Link>
                          </h5>
                          <div className="loc-blk d-flex align-items-center justify-content-center">
                            <i className="feather-map-pin me-2"></i>
                            <p>France</p>
