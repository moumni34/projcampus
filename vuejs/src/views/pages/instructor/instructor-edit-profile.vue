								...
								<div class="settings-menu p-0">
									...
									<div class="course-group mb-0 d-flex">
										<div class="course-group-img d-flex align-items-center">
											<router-link to="instructor-profile"><img src="../../../assets/img/user/user11.jpg" alt="" class="img-fluid"></router-link>
											<div class="course-name">
												<h4><router-link to="instructor-profile">Your avatar</router-link></h4>
