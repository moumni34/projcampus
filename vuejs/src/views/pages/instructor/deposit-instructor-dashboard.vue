											...
											<div class="card-body">
												<div class="view-all-grp d-flex">
													<div class="student-ticket-view">
														...
														<router-link to="dashboard-instructor" >View All</router-link>
													</div>
											...
											<div class="card-body">
												<div class="view-all-grp d-flex">
													<div class="student-ticket-view">
														...
														<router-link to="transactions-instructor" >View All</router-link>
													</div>
													<div class="img-deposit-ticket">
											...
											<div class="card-body">
												<div class="view-all-grp d-flex">
													<div class="student-ticket-view">
														<h3>$2055</h3>
														<p>Total Withdraw</p>
														<router-link to="withdrawal-instructor" >View All</router-link>
													</div>
													<div class="img-deposit-ticket">
